/**
 * Tiny promise wrapper over IndexedDB. Three stores: dumps, library, audio.
 *
 * No library so there is nothing to keep up to date. If this ever needs a
 * real backend, swap the functions here and nothing above changes.
 */
